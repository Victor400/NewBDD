  ...
  public  class DropDownList
    {
        ...
        public void TestList()
        {
            ...
            IWebElement webelment = ObjectRepository.Driver.FindElement(By.XPath("//a[@id='enter_bug']/span"));
            Console.WriteLine("Text : {0}", webelment.Text);
            ...
            //  select.SelectByValue("critical");
            //  select.SelectByText("major");
            //  Console.WriteLine("SelectedValue : {0}", select.SelectedOption.Text);
            ...
            ComboBoxHelper.SelectElement(By.Id("bug_severity"), "critical");
